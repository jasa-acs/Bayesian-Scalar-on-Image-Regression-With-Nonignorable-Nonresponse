The online supplement contains Package and Codes (with markdown files for the package and codes) for paper "Bayesian Scalar on Image Regression with Non-ignorable Non-response".

***************
This is the ReadMe document for conducting the data analysis presented in the paper.

*************** 
Platform: The implementation is done using R software (R version 3.6.1).
